...
export function useMap() {
  ...
  const markers = ref([
    {
      ...
      latitude: 39.909,
      longitude: 116.39742,
      iconPath: "/static/images/map/avatar1.webp",
      width: 48,
      height: 48,
      // title: "总部位置",
      anchor: { x: 0.5, y: 1 },
    ...
    },
    {
      ...
      latitude: 39.9,
      longitude: 116.39,
      iconPath: "/static/images/map/avatar2.webp",
      width: 48,
      height: 48,
      // title: "分部位置",
      anchor: { x: 0.5, y: 1 },
    },
    {
      ...
      latitude: 39.915,
      longitude: 116.405,
      iconPath: "/static/images/map/avatar3.webp",
      width: 48,
      height: 48,
      // title: "重要地点",
      anchor: { x: 0.5, y: 1 },
    ...
    },
    {
      ...
      latitude: 39.895,
      longitude: 116.385,
      iconPath: "/static/images/map/avatar4.webp",
      width: 48,
      height: 48,
      // title: "普通标记",
      anchor: { x: 0.5, y: 0.5 },
  ...
  const addMarker = (item) => {
    ...
    const markerData = {
      ...
      iconPath: `/static/images/map/avatar${item.id}.webp`,
      width: 48,
      height: 48,
      anchor: { x: 0.5, y: 1 },
      zIndex: 50,
