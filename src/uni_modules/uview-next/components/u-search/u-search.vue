<template>
	...
	>
		...
		>
			...
			<view v-if="searchIcon" class="u-search__content__icon">
				<u-icon
					@tap="clickIcon"
				    :size="searchIconSize"
				    :name="searchIcon"
...
<script>
	 ...
	 * @property {String | Boolean} searchIcon			输入框左边的图标，可以为uView图标名称或图片路径  (默认 'search' )
	...
	export default {
		...
		// #ifdef VUE3
		emits: [ 'update:modelValue', 'change','search',  'clear', 'focus', 'blur', 'click', 'clickIcon','custom'],
		// #endif
		methods: {
