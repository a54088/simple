<template>
    ...
    >
        ...
        <u-line v-if="border" :color="elBorderColor"></u-line>
    </view>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            hoverClass() {
                return !this.disabled && (this.clickable || this.isLink)
                    ? 'u-cell--clickable'
                    : '';
            },
            titleTextStyle() {
        ...
        methods: {
            init() {
                ...
                // if (!this.parent) {
                //     uni.$u.error('u-cell必须搭配u-cell-group组件使用')
                // }
            },
            updateParentData() {
                this.getParentData('u-cell-group');
            },
            // 点击cell
            clickHandler(e) {
