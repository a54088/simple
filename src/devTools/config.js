/*
 * @Author: 王硕
 * @Date: 2024-10-06 21:57:30
 * @LastEditors: 王硕
 * @LastEditTime: 2025-08-15 20:09:49
 * @Description:
 */
const DevWhiteUsers = ["18983402378", "15803902680"];
const currentMobile = uni.getStorageSync("aq--userInfo")?.mobile;
const isOpen =
  process.env.NODE_ENV === "development" ||
  DevWhiteUsers.includes(currentMobile);
let config = {
  status: isOpen, //调试工具总开关
